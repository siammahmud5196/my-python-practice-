...
thread_c = threading.Thread(target=sent_notification)
thread_a = threading.Thread(target=payment_process)
thread_b = threading.Thread(target=prepare_order)
...
async def get_weather():
    print("weather API request sended")
    
    await asyncio.sleep(3)
    
    print("weather data recived")
    
    
async def get_news():
    print("news API request sent")
    await asyncio.sleep(2)
    print("news data recieved")
    
    
async def  get_currency():
    print("currency API request sended")
    await asyncio.sleep(1)
    print("currency data recieved")
...
class Student():
    ...
    def introduce(self):
      ...
      print(f"i am in {self.department}  department")
      print(f"my age is {self.age}")
      
      
student = Student("siam",
                      23,
                      "swe"    
)
...
json_data = json.dumps(student_dict,indent=4)
